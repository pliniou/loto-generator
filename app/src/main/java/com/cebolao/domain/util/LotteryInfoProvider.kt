...
object LotteryInfoProvider {
    ...
    private val lotofacilInfo = LotteryInfo(
    ...
    private val quinaInfo = LotteryInfo(
    ...
    private val lotomaniaInfo = LotteryInfo(
     ...
     private val timemaniaInfo = LotteryInfo(
    ...
    private val duplaSenaInfo = LotteryInfo(
    ...
    private val diaDeSorteInfo = LotteryInfo(
    ...
    private val superSeteInfo = LotteryInfo(
     ...
     private val maisMilionariaInfo = LotteryInfo(
